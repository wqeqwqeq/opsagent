  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        // Resource prefix for deriving storage account name
        {
...
resource storageAccount 'Microsoft.Storage/storageAccounts@2023-01-01' = {
  ...
  kind: 'StorageV2'
  properties: {
    publicNetworkAccess: 'Enabled'  // Required for anonymous blob read
    networkAcls: {
      bypass: 'AzureServices'
      defaultAction: 'Deny'
      virtualNetworkRules: [
    ...
    allowBlobPublicAccess: true  // Enable anonymous blob read
  }
}
...
// Standup Recordings Container
resource standupContainer 'Microsoft.Storage/storageAccounts/blobServices/containers@2023-01-01' = {
  parent: blobService
  name: 'standup-recordings'
  properties: {
    publicAccess: 'Blob'  // Anonymous read for individual blobs
  }
}
